...
export async function generateMetadata({
  ...
  if (resume?.firstName === undefined && resume?.lastName === undefined) {
    return {
      title: "Ncst Student Ai Resume Builder",
      description:
  ...
  return {
    ...
    ${resume?.lastName}${resume?.lastName && " "}- Ncst Student Ai Resume Builder`,
    description: `${resume?.firstName} ${resume?.lastName}'s Resume. Powered by Ncst Student Ai Resume Builder.`,
  };
}
